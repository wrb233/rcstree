...
public:
	...
	//将qstringlist写入csv
	static void writeCSVFileByInfo(QList<QString> list, QString filePath);
	...
	//根据atype列表组装模板字符串
	static QString joinTemplate(QList<AType> atypeList,ObId obId,OType otype,int& index,QMap<ObId,int> mvMap,QMap<ObId,int> dpsMap,ChoiceData deviceProperty);
