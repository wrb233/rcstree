...
DPSPointImportDialog::DPSPointImportDialog(QStandardItem* parentItem, QWidget* parent, Qt::WindowFlags flags ): CpsDialog( parent, flags )
{
	ui.setupUi(this);
	initTreeview();
...
DPSPointImportDialog::~DPSPointImportDialog()
{
	delete treeModel;
}

void DPSPointImportDialog::initTreeview()
{
...
void DPSPointImportDialog::updateTreeModel()
{
	treeModel->clear();
...
void DPSPointImportDialog::addTreeItem(QStandardItem* parent)
{
	StringData nameData = "";
...
void DPSPointImportDialog::slotTreeExpanded(const QModelIndex  index)//只展开遥信节点
{
...
void DPSPointImportDialog::on_okButton_clicked()
{
	...
	QList<ObId> obIds = getListOfDPSPointObId();
...
QList<ObId> DPSPointImportDialog::getListOfDPSPointObId()
{	
...
void DPSPointImportDialog::createRemoteTree(QStandardItem *parentItem,ObId parentId,QList<ObId> lstObid)
{
...
void DPSPointImportDialog::appendTreeItem(QStandardItem *parentItem,ObId curId)
{
	StringData nameData;
...
void DPSPointImportDialog::writeAttribute(ObId sourceId, ObId dstId)
{
